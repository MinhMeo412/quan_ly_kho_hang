...
CREATE TABLE user(
	...
	CONSTRAINT fk_permission_level FOREIGN KEY (permission_level) REFERENCES permission(permission_level),
...
CREATE TABLE warehouse_stock(
	...
	CONSTRAINT fk_warehouse_id FOREIGN KEY (warehouse_id) REFERENCES warehouse(warehouse_id) ON DELETE CASCADE,
	CONSTRAINT fk_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES product_variant(product_variant_id) ON DELETE CASCADE,
	CONSTRAINT pk_warehouse_id_product_variant_id PRIMARY KEY (warehouse_id, product_variant_id),
...
CREATE TABLE inventory_audit_detail(
	...
	CONSTRAINT fk_inventory_audit_id FOREIGN KEY (inventory_audit_id) REFERENCES inventory_audit(inventory_audit_id) ON DELETE CASCADE,
	CONSTRAINT fk_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES product_variant(product_variant_id) ON DELETE CASCADE,
	CONSTRAINT pk_inventory_audit_id_product_variant_id PRIMARY KEY (inventory_audit_id, product_variant_id),
...
CREATE TABLE inbound_shipment_detail(
	...
	CONSTRAINT fk_inbound_shipment_id FOREIGN KEY (inbound_shipment_id) REFERENCES inbound_shipment(inbound_shipment_id) ON DELETE CASCADE,
	CONSTRAINT fk_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES product_variant(product_variant_id) ON DELETE CASCADE,
	CONSTRAINT pk_inbound_shipment_id_product_variant_i PRIMARY KEY (inbound_shipment_id, product_variant_id),
...
CREATE TABLE outbound_shipment_detail(
	...
	CONSTRAINT fk_outbound_shipment_id FOREIGN KEY (outbound_shipment_id) REFERENCES outbound_shipment(outbound_shipment_id) ON DELETE CASCADE,
	CONSTRAINT fk_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES product_variant(product_variant_id) ON DELETE CASCADE,
	CONSTRAINT pk_outbound_shipment_id_product_variant PRIMARY KEY (outbound_shipment_id, product_variant_id),
...
CREATE TABLE stock_transfer_detail(
	...
	CONSTRAINT fk_stock_transfer_id FOREIGN KEY (stock_transfer_id) REFERENCES stock_transfer(stock_transfer_id) ON DELETE CASCADE,
	CONSTRAINT fk_product_variant_id FOREIGN KEY (product_variant_id) REFERENCES product_variant(product_variant_id) ON DELETE CASCADE,
	CONSTRAINT pk_stock_transfer_id_product_variant_id PRIMARY KEY (stock_transfer_id, product_variant_id),

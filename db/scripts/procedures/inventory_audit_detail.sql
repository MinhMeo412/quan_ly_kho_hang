...
CREATE PROCEDURE create_inventory_audit_detail(
    ...
    IN input_inventory_audit_detail_stock_quantity INT,
...
BEGIN
    ...
    IF sufficient_permission(input_token, required_level) THEN
        INSERT INTO inventory_audit_detail(inventory_audit_id, product_variant_id, inventory_audit_detail_stock_quantity, inventory_audit_detail_actual_quantity) VALUES
        (input_inventory_audit_id, input_product_variant_id, input_inventory_audit_detail_stock_quantity, input_inventory_audit_detail_actual_quantity);
    ELSE
...
BEGIN
    ...
    IF sufficient_permission(input_token, required_level) THEN
        ...
        SET inventory_audit_detail_stock_quantity = input_inventory_audit_detail_stock_quantity,
            inventory_audit_detail_actual_quantity = input_inventory_audit_detail_actual_quantity

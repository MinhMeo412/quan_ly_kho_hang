...
namespace WarehouseManager.UI.Menu
{
    public static class AddInboundShipment
    {
        public static void Display()
        {
            ...
            {
                X = 20,
                Y = Pos.Bottom(supplierNameInput) + 2,
                Width = 50,
                Height = 3,
                Text = "",
            };
            ...
            container.Add(warehouseLabel, warehouseInput, descriptionLabel, dateLabel, dateInput, userLabel, userInput, statusLabel, statusBox, supplierNameLabel, supplierNameInput, descriptionInput);
